...
clean :
	rm -f generacion.o test test.o test.asm test_01.o test_01.asm test_02.o test_02.asm test_03.o test_03.asm test_04.o test_04.asm test_05.o test_05.asm test_06.o test_06.asm test_07.o test_07.asm $(TESTS)
